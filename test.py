...
word2ind, ind2word = sen2inds.get_worddict('/Users/limin/opt/anaconda3/envs/risk/limin/textCNN_demo/data/wordLabel.txt')
label_w2n, label_n2w = sen2inds.read_labelFile('/Users/limin/opt/anaconda3/envs/risk/limin/textCNN_demo/data/label.txt')
...
def main():
    ...
    weightFile = '/Users/limin/opt/anaconda3/envs/risk/limin/textCNN_demo/weight.pkl'
    ...
    numAll = 0
    numRight = 0
    testData = get_valData('/Users/limin/opt/anaconda3/envs/risk/limin/textCNN_demo/data/valdata_vec.txt')
